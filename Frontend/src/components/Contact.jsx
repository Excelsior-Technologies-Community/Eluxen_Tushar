  ...
  return (
    <section className="contact-bg">
      ...
      <div className="contact-left">
        ...
        <h2>Let's Connect <br />Reach <br />Out to Our Team</h2>
        ...
        <form onSubmit={handleSubmit} className="contact-form">
          ...
          <button type="submit" className="contact-btn" disabled={status === "loading"}>
            ...
            <span className="btn-icon">
              <img src="https://html.designingmedia.com/eluxen/assets/images/up-right-arrow.png" alt="arrow" />
            </span>
          </button>
          ...
          {status === "error" && (
            <p className="form-msg error">❌ Something went wrong. Please try again.</p>
          )}
        </form>
      </div>
